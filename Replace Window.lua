...
function samp.onServerMessage(color, text)
	...
	if color == -2686721 and text:find('.- .-: .+') and notifications[8][3][0] and not text:find('Сообщение до редакции:') and not text:find('%[FOREVER%]') and not text:find('%[Cобиратели%]') and not text:find('%[Риелторское агенство%]') then
